...
def recognize_face_dlib(image):
    ...
    #image = face_recognition.load_image_file(img_path)  # TODO is it special loading?
    ...
    for face_location in face_locations:
        ...
        # pil_image = Image.fromarray(face_image)  # For image saving, convert array to image format
        # pil_image.save('face0_%i.jpg' % i)
